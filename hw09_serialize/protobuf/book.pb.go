...
func (x *BookSlice) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*BookSlice) ProtoMessage() {}

func (x *BookSlice) ProtoReflect() protoreflect.Message {
	mi := &file_book_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use BookSlice.ProtoReflect.Descriptor instead.
func (*BookSlice) Descriptor() ([]byte, []int) {
	return file_book_proto_rawDescGZIP(), []int{1}
}

func (x *BookSlice) GetBooks() []*Book {
	if x != nil {
		return x.Books
	}
	return nil
...
var file_book_proto_rawDesc = []byte{
	...
	0x04, 0x72, 0x61, 0x74, 0x65, 0x22, 0x2d, 0x0a, 0x09, 0x42, 0x6f, 0x6f, 0x6b, 0x53, 0x6c, 0x69,
	0x63, 0x65, 0x12, 0x20, 0x0a, 0x05, 0x62, 0x6f, 0x6f, 0x6b, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28,
	0x0b, 0x32, 0x0a, 0x2e, 0x6d, 0x61, 0x69, 0x6e, 0x2e, 0x42, 0x6f, 0x6f, 0x6b, 0x52, 0x05, 0x62,
	0x6f, 0x6f, 0x6b, 0x73, 0x42, 0x0d, 0x5a, 0x0b, 0x2e, 0x2f, 0x3b, 0x70, 0x72, 0x6f, 0x74, 0x6f,
...
var file_book_proto_goTypes = []interface{}{
	...
	(*BookSlice)(nil), // 1: main.BookSlice
}
var file_book_proto_depIdxs = []int32{
	0, // 0: main.BookSlice.books:type_name -> main.Book
